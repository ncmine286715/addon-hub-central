...
const appCss = "/assets/styles-Dt7pMPSH.css";
...
const Pickaxe = createLucideIcon("pickaxe", __iconNode$4);
const __iconNode$3 = [
...
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 backdrop-blur-xl bg-background/70 border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-gradient-neon flex items-center justify-center shadow-neon group-hover:scale-105 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pickaxe, { className: "w-5 h-5 text-primary-foreground", strokeWidth: 2.5 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-pixel text-[11px] sm:text-xs text-primary text-glow", children: "MineAddons" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-pixel text-[9px] sm:text-[10px] text-muted-foreground", children: ".NEWS" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/", children: "Início" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/addons", children: "Addons" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/categories", children: "Categorias" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/tutorial", children: "Como Instalar" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Buscar addon..." })
        ]
      }
    )
  ] }) });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-24 border-t border-border/60 bg-surface/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-pixel text-xs text-primary mb-3", children: "NCMINE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Criador de addons do Minecraft Bedrock. 140k+ no TikTok. O melhor lugar pra baixar addons sem dor de cabeça." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground mb-3", children: "Navegação" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/addons", className: "hover:text-primary transition", children: "Todos os addons" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", className: "hover:text-primary transition", children: "Categorias" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/tutorial", className: "hover:text-primary transition", children: "Como instalar" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin", className: "hover:text-primary transition opacity-60", children: "Painel admin" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground mb-3", children: "Me siga" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Social, { href: "https://www.tiktok.com/@ncmine", label: "TikTok", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Social, { href: "#", label: "YouTube", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "w-4 h-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Social, { href: "#", label: "Instagram", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-4 h-4" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-6 border-t border-border/60 text-xs text-muted-foreground flex flex-col sm:flex-row justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " MineAddonsNews — feito por ncmine"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Não afiliado oficialmente à Mojang ou Microsoft." })
    ] })
  ] }) });
}
...
function isIOS(ua) {
  if (typeof window === "undefined" && true) return false;
  const u = (navigator.userAgent ?? "").toLowerCase();
...
function InAppBrowserBanner() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] bg-background/95 backdrop-blur-md flex items-end sm:items-center justify-center p-4 animate-in fade-in duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md bg-gradient-card border-2 border-primary/40 rounded-2xl shadow-glow p-6 animate-in slide-in-from-bottom duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/15 border border-primary/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-5 h-5 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Aviso importante" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-bold", children: "Abra no navegador" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-5 leading-relaxed", children: [
      "Você está dentro do ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: app }),
      ". Para baixar do ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Terabox" }),
      " sem erros, abra esta página no navegador do seu celular."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Step, { n: 1, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(EllipsisVertical, { className: "w-4 h-4" }), children: [
        "Toque nos ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "3 pontinhos" }),
        " ",
        ios ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "(canto inferior)" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "(canto superior direito)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Step, { n: 2, icon: ios ? /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4" }), children: [
        "Escolha ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: '"Abrir no navegador"' }),
        ios ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: ' ou "Abrir no Safari"' }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: ' ou "Chrome"' })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Step, { n: 3, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4" }), children: "Pronto! O download vai funcionar normal." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
...
function Step({ n, icon, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-7 h-7 rounded-full bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center", children: n }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground pt-1 flex items-center gap-2 flex-wrap", children: [
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[60vh] items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-pixel text-5xl text-primary text-glow mb-4", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-2", children: "Página não encontrada" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "Esse addon foi minerado e não está mais aqui." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InAppBrowserBanner, {}),
...
const $$splitComponentImporter$6 = () => import("./tutorial-OZBDTDBe.js");
const Route$6 = createFileRoute("/tutorial")({
  head: () => ({
    meta: [{
      title: "Como instalar addons no Minecraft Bedrock — MineAddonsNews"
    }, {
      name: "description",
      content: "Tutorial completo: como baixar do Terabox e instalar addons no Minecraft Bedrock (celular e PC)."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./categories-DIUlqF_q.js");
const Route$5 = createFileRoute("/categories")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Navegue por categorias: addons, texturas, mods, mapas e mais para Minecraft Bedrock."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./auth-Dad6FMNx.js");
const Route$4 = createFileRoute("/auth")({
  head: () => ({
    meta: [{
      title: "Entrar — Painel admin | MineAddonsNews"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin-Bacrs0TB.js");
const Route$3 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "Painel Admin — MineAddonsNews"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./addons-JsbXGvwd.js");
const Route$2 = createFileRoute("/addons")({
  head: () => ({
    meta: [{
      title: "Todos os Addons — MineAddonsNews"
    }, {
      name: "description",
      content: "Procure entre todos os addons de Minecraft Bedrock disponíveis. Filtre por categoria e baixe fácil pelo Terabox."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-DO7X7oa2.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Baixe os melhores addons, texturas e mods de Minecraft Bedrock. Catálogo organizado, download fácil pelo Terabox. Por ncmine."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitNotFoundComponentImporter = () => import("./addon._slug-BakrULVI.js");
const $$splitComponentImporter = () => import("./addon._slug-CYssPKQm.js");
const Route2 = createFileRoute("/addon/$slug")({
  component: lazyRouteComponent($$splitComponentImporter, "component"),
  notFoundComponent: lazyRouteComponent($$splitNotFoundComponentImporter, "notFoundComponent")
});
const TutorialRoute = Route$6.update({
  id: "/tutorial",
  path: "/tutorial",
...
const AddonsRoute = Route$2.update({
  id: "/addons",
  path: "/addons",
  getParentRoute: () => Route$7
});
...
const AddonSlugRoute = Route2.update({
  id: "/addon/$slug",
  path: "/addon/$slug",
  getParentRoute: () => Route$7
});
